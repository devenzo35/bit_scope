...
from config.config import INGESTION_DATA_DIR, TRANSFORM_DATA_DIR, COINDESK_ID

# Rutas basadas en config
raw_path = INGESTION_DATA_DIR / COINDESK_ID / "raw_coindesk_articles.json"
out_dir = TRANSFORM_DATA_DIR / COINDESK_ID
